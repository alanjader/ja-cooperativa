...
-- Políticas genéricas
drop policy if exists tenant_cooperados on cooperativa.cooperados;
create policy tenant_cooperados on cooperativa.cooperados for all
  using (cooperativa_id = cooperativa.current_cooperativa_id());
drop policy if exists tenant_cooperativas on cooperativa.cooperativas;
create policy tenant_cooperativas on cooperativa.cooperativas for all
  using (id = cooperativa.current_cooperativa_id());
drop policy if exists tenant_fazendas on cooperativa.fazendas;
create policy tenant_fazendas on cooperativa.fazendas for all
  using (cooperado_id in (select id from cooperativa.cooperados where cooperativa_id = cooperativa.current_cooperativa_id()));
drop policy if exists tenant_safras on cooperativa.safras;
create policy tenant_safras on cooperativa.safras for all
  using (cooperativa_id = cooperativa.current_cooperativa_id());
drop policy if exists tenant_lotes on cooperativa.lotes;
create policy tenant_lotes on cooperativa.lotes for all
  using (cooperativa_id = cooperativa.current_cooperativa_id());
drop policy if exists tenant_certificacoes on cooperativa.certificacoes;
create policy tenant_certificacoes on cooperativa.certificacoes for all
  using (cooperado_id in (select id from cooperativa.cooperados where cooperativa_id = cooperativa.current_cooperativa_id()));
drop policy if exists tenant_auditorias on cooperativa.auditorias;
create policy tenant_auditorias on cooperativa.auditorias for all
  using (cooperativa_id = cooperativa.current_cooperativa_id());
drop policy if exists tenant_visitas_atr on cooperativa.visitas_atr;
create policy tenant_visitas_atr on cooperativa.visitas_atr for all
  using (cooperativa_id = cooperativa.current_cooperativa_id());
drop policy if exists tenant_entregas on cooperativa.entregas;
create policy tenant_entregas on cooperativa.entregas for all
  using (cooperativa_id = cooperativa.current_cooperativa_id());
drop policy if exists tenant_vendas on cooperativa.vendas;
create policy tenant_vendas on cooperativa.vendas for all
  using (cooperativa_id = cooperativa.current_cooperativa_id());
drop policy if exists tenant_alertas on cooperativa.alertas;
create policy tenant_alertas on cooperativa.alertas for all
  using (cooperativa_id = cooperativa.current_cooperativa_id());
drop policy if exists tenant_documentos on cooperativa.documentos;
create policy tenant_documentos on cooperativa.documentos for all
  using (cooperativa_id = cooperativa.current_cooperativa_id());
